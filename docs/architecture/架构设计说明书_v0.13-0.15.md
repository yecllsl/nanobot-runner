...
class SkillManager:
    ...
    def __init__(self, workspace: Path, disabled_skills: set[str] | None = None) -> None:
        self.loader = SkillsLoader(workspace=workspace, disabled_skills=disabled_skills)
...
class ToolManager:
    ...
    def __init__(self, config: ToolsConfig) -> None:
        self.config = config
        self.mcp_clients: dict[str, MCPToolWrapper] = {}
    
    async def connect_tools(self) -> dict[str, bool]:
        """连接所有配置的工具"""
        pass
...
class MemoryManager:
    ...
    def __init__(self, workspace: Path) -> None:
        self.store = MemoryStore(workspace=workspace)
    ...
    def write_personality(self, content: str) -> None:
        """写入 AI 人格"""
        pass
    
    def get_memory_version(self) -> str:
        """获取记忆版本"""
        pass
    
    def restore_memory_version(self, version: str) -> bool:
        """恢复记忆版本"""
        pass
```
