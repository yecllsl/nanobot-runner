...
class TestAgentToolsAggregation:
    ...
    def test_query_by_date_range_aggregation(
        self, mock_storage, sample_run_data
    ):
        """测试日期范围查询的聚合逻辑"""
        # 保存数据
    ...
    def test_query_by_date_range_single_day(
        self, mock_storage, sample_run_data
    ):
        """测试查询单天的数据"""
        # 保存数据
    ...
    def test_query_by_distance_aggregation(
        self, mock_storage, sample_run_data
    ):
        """测试距离查询的聚合逻辑"""
        # 保存数据
    ...
    def test_query_by_distance_range(
        self, mock_storage, sample_run_data
    ):
        """测试距离范围查询"""
        # 保存数据
    ...
    def test_get_recent_runs_aggregation(
        self, mock_storage, sample_run_data
    ):
        """测试最近跑步记录的聚合逻辑"""
        # 保存数据
    ...
    def test_sampling_points_not_returned_as_runs(
        self, mock_storage, sample_run_data
    ):
        """测试采样点不会被作为单独的跑步返回"""
        # 保存数据（12600 个采样点）
    ...
    def test_distance_not_duplicated_in_results(
        self, mock_storage, sample_run_data
    ):
        """测试距离数据不会在结果中重复"""
        # 保存数据
