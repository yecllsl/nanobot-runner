...
"""
    ...
    for i in range(min(10, activity_data.get('record_count', 10))):  # 只添加前10条记录作为示例
        timestamp = (datetime.fromisoformat(activity_data['time_created'].replace('Z', '')) + 
    ...
    for i, activity_type in enumerate(activity_types):
        for day in range(7):  # 每类活动生成7天的数据
            ...
            activity_data = {
                ...
                "max_heart_rate": random.randint(activity_type['hr_range'][1], activity_type['hr_range'][1] + 20),
