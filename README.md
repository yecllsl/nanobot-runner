...
> **最新版本**: v0.18.0 - 数据导出与可视化模块，支持CSV/JSON/Parquet格式导出与多维度数据可视化
...
```bash
# 指定版本安装
curl -fsSL https://raw.githubusercontent.com/yecllsl/nanobot-runner/main/scripts/install.sh | bash -s -- --version v0.17.0
