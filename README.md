...
> **最新版本**: v0.13.0 - 新增智能技能生态版（MCP工具管理+天气/地图/健康数据Agent工具）
...
# 指定版本安装
curl -fsSL https://raw.githubusercontent.com/yecllsl/nanobot-runner/main/scripts/install.sh | bash -s -- --version v0.13.0
