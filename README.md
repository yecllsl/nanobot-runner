...
[![Code Coverage](https://img.shields.io/badge/coverage-84%25-brightgreen.svg)](./coverage.xml)
[![Tests](https://img.shields.io/badge/tests-2271%20passed-brightgreen.svg)]()
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

> **最新版本**: v0.9.5 - Gateway服务增强、报告数据修复、测试策略改进
...
- 📱 **飞书推送**: 支持周报/月报自动推送，支持飞书机器人交互 (v0.9.5)
- ⚙️ **配置管理**: 交互式初始化向导，支持配置备份和迁移 (v0.9.4)
- 🚀 **智谱AI**: 支持智谱AI LLM Provider (v0.9.5)
...
# 指定版本安装
curl -fsSL https://raw.githubusercontent.com/yecllsl/nanobot-runner/main/scripts/install.sh | bash -s -- --version v0.9.5
