...
> **最新版本**: v0.19.0 - 身体信号分析模块，支持HRV分析、疲劳度评估、恢复状态监控与身体信号智能解读
...
```bash
# 指定版本安装
curl -fsSL https://raw.githubusercontent.com/yecllsl/nanobot-runner/main/scripts/install.sh | bash -s -- --version v0.19.0
